clc;close all;clear
data=readtable('路段1原.xlsx');

timedata=table2array(data(1:90,10),'InputFormat','HH:mm:ss');
v=table2array(data(1:90,9));
...
data=readtable('路段2原.xlsx');

timedata=table2array(data(1:113,10),'InputFormat','HH:mm:ss');
v=table2array(data(1:113,9));
time = datetime(timedata);
...
data=readtable('路段3原.xlsx');

timedata=table2array(data(1:26,10),'InputFormat','HH:mm:ss');
v=table2array(data(1:26,9));
time = datetime(timedata);
